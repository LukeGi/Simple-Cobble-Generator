...
public class CobbleGen extends Block implements ITileEntityProvider {
  ...
  public static class Tile extends TileEntity implements IItemHandler {
     ...
     * <p>
     * <p/>
     * IMPORTANT: This ItemStack MUST NOT be modified. This method is not for altering an inventories contents. Any implementers who are able to detect modification through this method should throw an
     * exception.
     * <p/>
    ...
    /**
     * Uses configs and any stored energy to figure out the maximum amount of cobble that this block can produce right now.
     *
    ...
    /**
     * Extracts an ItemStack from the given slot. The returned value must be empty if nothing is extracted, otherwise it's stack size must less than than amount and {@link
     * ItemStack#getMaxStackSize()}.
     *
     * @param slot Slot to extract from.
     * @param amount Amount to extract (may be greater than the current stacks max limit)
     * @param simulate If true, the extraction is only simulated
     * @return ItemStack extracted from the slot, must be empty if nothing can be extracted. The returned ItemStack can be safely modified after, so item handlers should return a new or copied stack.
     **/
    @Nonnull
    @Override
